            ...
            <div className='py-4 overflow-y-auto'>
                <ul className='text-slate-700 dark:text-slate-100'>
                    ...
                    <li className='mt-1 mb-5'>
                        ...
                        <div className='flex items-center my-1'>
                            <input type="radio" id='rating-sort 1' value="" name='rating-sort' className='w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600'/>
                            <label htmlFor="rating-sort-1" className='ml-2 text-sm font-medium text-gray-900 dark:text-gray-300'>4 Stars & Above</label>
                        </div>
                        <div className='flex items-center my-1'>
                            <input type="radio" id='rating-sort 2' value="" name='rating-sort' className='w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600'/>
                            <label htmlFor="rating-sort-2" className='ml-2 text-sm font-medium text-gray-900 dark:text-gray-300'>3 Stars & Above</label>
                        </div>
                        <div className='flex items-center my-1'>
                            <input type="radio" id='rating-sort 3' value="" name='rating-sort' className='w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600'/>
                            <label htmlFor="rating-sort-3" className='ml-2 text-sm font-medium text-gray-900 dark:text-gray-300'>2 Stars & Above</label>
                        </div>
                        <div className='flex items-center my-1'>
                            <input type="radio" id='rating-sort 4' value="" name='rating-sort' className='w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600'/>
