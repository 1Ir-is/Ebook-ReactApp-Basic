  ...
  return (
    <section className='filter'>
        <div id="drawer-disable-body-scrolling" className={`fixed z-40 h-screen p-5 overflow-y-auto bg-white w-72 dark:bg-gray-800 transition-transhtmlForm left-0 top-0 transhtmlForm-none`} tabIndex="-1" aria-labelledby="drawer-disable-body-scrolling-label" aria-modal="true" role="dialog">
            <h5 id='drawer-disable-body-scrolling-label' className='text-base font-semibold text-gray-500 uppercase dark:text-gray-400'>Filter</h5>
                ...
                <ul className='text-slate-700 dark:text-slate-100'>
                    <li className='mt-1 mb-5'>
                        ...
                        <div className='flex items-center my-1'>
                            <input type="radio" id='price-sort-1' value="" name='price-sort' className='w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600' />
                            <label htmlFor="price-sort-1" className='ml-2 text-sm font-medium text-gray-900 dark:text-gray-300'>Price - Low to High</label>
                        </div>
                        <div className='flex items-center my-1'>
                            <input type="radio" id='price-sort-2' value="" name='price-sort' className='w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600' />
                    ...
                    <li className='mt-1 mb-5'>
                        ...
                        <div className='flex items-center my-1'>
                            <input type="radio" id='rating-sort 1' value="" name='rating-sort-1' className='w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600'/>
                            <label htmlFor="rating-sort-1" className='ml-2 text-sm font-medium text-gray-900 dark:text-gray-300'>4 Stars & Above</label>
                        </div>
                        <div className='flex items-center my-1'>
                            <input type="radio" id='rating-sort 2' value="" name='rating-sort-2' className='w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600'/>
                            <label htmlFor="rating-sort-2" className='ml-2 text-sm font-medium text-gray-900 dark:text-gray-300'>3 Stars & Above</label>
                        </div>
                        <div className='flex items-center my-1'>
                            <input type="radio" id='rating-sort 3' value="" name='rating-sort-3' className='w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600'/>
                            <label htmlFor="rating-sort-3" className='ml-2 text-sm font-medium text-gray-900 dark:text-gray-300'>2 Stars & Above</label>
                        </div>
                        <div className='flex items-center my-1'>
                            <input type="radio" id='rating-sort 4' value="" name='rating-sort-4' className='w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600'/>
                            <label htmlFor="rating-sort-4" className='ml-2 text-sm font-medium text-gray-900 dark:text-gray-300'>1 Stars & Above</label>
                        </div>
                    </li>
                    <li className='mt-1 mb-5'>
                        <span className='font-semibold'>Other Filter</span>
                        <div className='flex items-center my-1'>
                            <input type="checkbox" id='best-seller' value="" className='w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 dark:bg-gray-700 dark:border-gray-600'/>
                            <label htmlFor="best-seller" className='ml-2 text-sm font-medium text-gray-900 dark:text-gray-300'>Best Seller Only</label>
                        </div>
                        <div>
                            <input type="checkbox" id='only-instock' value="" className='w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 dark:bg-gray-700 dark:border-gray-600'/>
