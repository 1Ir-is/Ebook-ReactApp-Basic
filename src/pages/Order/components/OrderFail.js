  ...
  return (
    <section className="text-xl text-center max-w-4xl mx-auto my-10 py-5 dark:text-slate-100 border dark:border-slate-700 rounded">
      ...
      <div className="my-5">
        ...
        <p>
          Connect <a href="mailto:eBookSphere@example.com" className="text-blue-600 dark:text-blue-400 hover:underline hover:underline-offset-8">eBookSphere@example.com</a> for support.
        </p>
      </div>
