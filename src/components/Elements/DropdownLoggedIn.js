...
export const DropdownLoggedIn = () => {
  return (
    <div id='dropdownAvatar' className='select-none absolute top-10 righ-0 z-10 bg-white w-44 rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600'>
        ...
        <div className='py-1'>
            <span className='cursor-pointer block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-200 dark:hover:text-white dark:hover:bg-gray-600'>Log out</span>
        </div>
    </div>
  )
}
